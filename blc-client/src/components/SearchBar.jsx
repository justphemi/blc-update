...
const SearchBar = () => {
  ...
  return showSearch && visible ? (
    <div className='border-b-[0.1rem] border-gray-200 text-center'>
      ...
      <img onClick={() => setShowSearch(false)} src={assets.cross_icon} className='inline w-3 cursor-pointer' alt="close_search" />
    </div>
  ) : null
}
